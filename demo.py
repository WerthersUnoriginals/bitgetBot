...
import datetime
import threading
# IMPORTANTE: Asegúrate de tener instalada la librería de Bitget y que soporta el modo demo.
...
# =============================================================================
# CONFIGURACIÓN Y PARÁMETROS PARA BITGET (Modo Demo)
# =============================================================================
# Estas credenciales deben corresponder a tu cuenta demo.
API_KEY = "bg_552e1a353f986624e2de24fae661f15f"
SECRET_KEY = "0bcd3c0042f776a72a4dde2cdb62aa03de5768701074f8ed17ae77956e006f53"
PASSPHRASE = "Queputamierdaesestosalu2"

SYMBOL = "RUNEUSDT_UMCBL"
MARGIN_COIN = "USDT"
USER_FUNDS = 5.0  # Por ejemplo, 5 USDT por operación
LEVERAGE = "10"   # Apalancamiento 10x

# =============================================================================
# CONFIGURACIÓN DEL ENTORNO (Demo vs. Producción)
# =============================================================================
DEMO_MODE = True

if DEMO_MODE:
    # URL base para el entorno demo. (Verifica en la documentación de Bitget el endpoint correcto)
    BASE_URL = "https://api.bitgetdemo.com"
else:
    BASE_URL = "https://api.bitget.com"

# Conexión a las API de Bitget utilizando la URL base (si la librería lo permite).
# En este ejemplo se asume que las clases aceptan un parámetro "base_url" para cambiar de entorno.
account_api = AccountApi(API_KEY, SECRET_KEY, PASSPHRASE, base_url=BASE_URL)
market_api  = MarketApi(API_KEY, SECRET_KEY, PASSPHRASE, base_url=BASE_URL)
order_api   = OrderApi(API_KEY, SECRET_KEY, PASSPHRASE, base_url=BASE_URL)
...
if __name__ == "__main__":
    print("Iniciando bot de trading con alertas vía email y Bitget (Modo Demo)...")
